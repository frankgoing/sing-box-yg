...
```
bash <(wget -qO- https://raw.githubusercontent.com/frankgoing/sing-box-yg/main/sb.sh)
```
或者
```
bash <(curl -Ls https://raw.githubusercontent.com/frankgoing/sing-box-yg/main/sb.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/frankgoing/sing-box-yg/main/serv00.sh)
```
